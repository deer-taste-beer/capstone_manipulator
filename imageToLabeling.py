...
def copy_images_based_on_json(json_folder, image_folder, target_folder):
    ...
    for json_file_name in os.listdir(json_folder):
        if json_file_name.endswith(".txt"):
...
# 사용 예시
json_folder_path = r'E:\병아리\test\test_lb'
image_folder_path = r'E:\병아리\test\test_img'
target_folder_path = r'E:\병아리\test'

copy_images_based_on_json(json_folder_path, image_folder_path, target_folder_path)